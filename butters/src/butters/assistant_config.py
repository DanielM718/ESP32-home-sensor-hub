...
def load_assistant_settings(path: Path | None = None) -> AssistantSettings:
    ...
    desktop = DesktopSettings(
        ...
        host=str(desktop_table.get("host", "169.254.227.84")),
        ...
        remote_enabled=bool(desktop_table.get("remote_enabled", True)),
        restore_enabled=bool(desktop_table.get("restore_enabled", True)),
